...
SECTION_DECLARATION: tuple[dict[str, Any], ...] = (
    {"key": "title-block", "label": "Title", "structural": True},
    {
        "key": "abstract",
        "label": "Abstract",
        "rule": {"source": "claims", "claim_classes": ["foundational-claim"],
                 "ref": "claim_ref", "limit": 2},
    },
    {
        "key": "keywords",
        "label": "Keywords",
    ...
    },
    {
        "key": "background",
        "label": "Background",
        "rule": {"source": "claims", "claim_classes": ["foundational-claim", "practice-claim",
                                                       "definitional-claim"],
                 "ref": "rationale_ref"},
    },
    {
        ...
        "rule": {"source": "claims", "claim_classes": ["determination"],
                 "derive_space": "decision", "derive_field": "problem_statement"},
    },
    {
        "key": "objective",
        "label": "Objective",
        "rule": {"source": "claims", "claim_classes": ["determination"],
                 "derive_space": "decision", "derive_field": "objective"},
    },
    {
        "key": "prior-art",
        "label": "Prior Art and Alternatives Considered",
        "rule": {"source": "claims", "claim_classes": ["determination"],
                 "derive_space": "decision", "derive_field": "alternatives"},
    },
    {
        "key": "related-work",
        "label": "Related Work",
        "rule": {"source": "claims", "claim_classes": ["determination", "practice-claim"],
                 "ref": "support_refs"},
    },
    {
        ...
        "rule": {"source": "claims", "claim_classes": ["determination"],
                 "derive_space": "decision", "derive_field": "evaluation_criteria"},
    },
    {
        "key": "method",
        "label": "Method",
        "rule": {"source": "claims", "claim_classes": ["method-claim", "practice-claim"],
                 "ref": "claim_ref"},
    },
    {
        "key": "architecture",
        "label": "Architecture",
        "rule": {"source": "claims", "claim_classes": ["specification-claim"],
                 "ref": "claim_ref"},
    },
    {
        "key": "normative-requirements",
        "label": "Normative Requirements",
        "rule": {"source": "claims", "claim_classes": ["normative-claim", "invariant-claim"],
                 "ref": "claim_ref"},
    },
    {
        "key": "specification",
    ...
    },
    {
        "key": "evaluation",
        "label": "Evaluation",
        "rule": {"source": "findings", "finding_classes": ["qualitative-verdict"],
                 "ref": "metric_ref"},
    },
    {
        "key": "contributions",
    ...
    },
    {
        ...
        "label": "Trade-offs",
        "rule": {"source": "claims", "claim_classes": ["determination"],
                 "derive_space": "decision", "derive_field": "tradeoffs"},
    },
    {
        "key": "risk-register",
        "label": "Risks",
        "rule": {"source": "claims", "claim_classes": ["determination"],
                 "derive_space": "decision", "derive_field": "risks"},
    },
    {
        "key": "limitations",
    ...
    },
    {
        ...
        "label": "Conclusion",
        "rule": {"source": "claims", "claim_classes": ["determination"],
                 "derive_space": "decision", "derive_field": "consequences"},
    },
    {
        "key": "future-work",
        "label": "Future Work",
        "rule": {"source": "claims", "claim_classes": ["determination"],
                 "derive_space": "decision", "derive_field": "implementation_guidance"},
    },
    {
        "key": "executive-summary",
        "label": "Executive Summary",
        "rule": {"source": "claims", "claim_classes": ["foundational-claim"],
                 "ref": "claim_ref", "limit": 1},
    },
    {
        "key": "business-context",
        "label": "Context",
        "rule": {"source": "claims", "claim_classes": ["determination"],
                 "derive_space": "decision", "derive_field": "context"},
    },
    {
        "key": "recommendation",
    ...
    },
    {
        ...
        "rule": {"source": "claims", "claim_classes": ["determination"],
                 "derive_space": "decision", "derive_field": "validation_strategy"},
    },
    {
        "key": "patent-field",
    ...
    },
    {
        ...
        "rule": {"source": "claims", "claim_classes": ["method-claim", "specification-claim",
                                                       "practice-claim"],
                 "ref": "claim_ref"},
    },
    {
        "key": "patent-claims",
        "label": "Claims",
        "rule": {"source": "claims", "claim_classes": ["normative-claim", "specification-claim",
                                                       "invariant-claim"],
                 "ref": "claim_ref"},
    },
    {
...
_ACADEMIC_CORE = [
    "title-block", "abstract", "keywords", "introduction", "background", "related-work",
    "method", "results", "evaluation", "discussion", "limitations", "conclusion",
    "future-work", "references", "provenance",
]
...
BUILT_IN_FORMATS: tuple[dict[str, Any], ...] = (
    {
        ...
        "required": ["title-block", "abstract", "introduction", "method", "results",
    ...
    },
    {
        ...
        "sections": [
            "title-block", "abstract", "keywords", "introduction", "background",
            "related-work", "method", "architecture", "results", "evaluation",
            "discussion", "limitations", "conclusion", "future-work", "substrate",
            "references", "provenance",
        ],
        "required": ["title-block", "abstract", "keywords", "introduction", "method",
                     "results", "discussion", "references", "provenance"],
        "renderer": "markdown",
        "extension": "md",
        "citation_style": "canonical-id",
        "audience": "journal",
    },
    {
        ...
        "sections": [
            "title-block", "abstract", "keywords", "introduction", "background",
            "method", "results", "evaluation", "discussion", "conclusion",
            "references", "provenance",
        ],
        "required": ["title-block", "abstract", "introduction", "method", "results",
                     "references", "provenance"],
    ...
    },
    {
        ...
        "sections": [
            "title-block", "abstract", "keywords", "introduction", "related-work",
            "method", "architecture", "results", "evaluation", "limitations",
            "conclusion", "references", "provenance",
        ],
        "required": ["title-block", "abstract", "introduction", "method", "results",
                     "references", "provenance"],
        "renderer": "markdown",
    ...
    },
    {
        ...
        "sections": ["title-block", "abstract", "introduction", "method", "results",
                     "conclusion", "references", "provenance"],
        "required": ["title-block", "abstract", "method", "results", "references",
                     "provenance"],
        "renderer": "markdown",
        "extension": "md",
        "citation_style": "canonical-id",
    ...
    },
    {
        ...
        "sections": ["title-block", "abstract", "keywords", "method", "results",
                     "references", "provenance"],
    ...
    },
    {
        ...
        "label": "White Paper",
        "sections": [
            "title-block", "executive-summary", "business-context", "problem-statement",
            "objective", "prior-art", "evaluation-criteria", "recommendation",
            "architecture", "tradeoffs", "risk-register", "results",
            "implementation-guidance", "conclusion", "references", "provenance",
        ],
        "required": ["title-block", "executive-summary", "problem-statement",
                     "recommendation", "references", "provenance"],
        "renderer": "markdown",
        "extension": "md",
        "citation_style": "canonical-id",
        "audience": "industry",
    },
    {
        ...
        "sections": ["title-block", "executive-summary", "business-context",
                     "recommendation", "results", "references", "provenance"],
    ...
    },
    {
        ...
        "sections": ["title-block", "executive-summary", "recommendation", "risk-register",
                     "provenance"],
        "required": ["title-block", "executive-summary", "recommendation", "provenance"],
        "renderer": "plaintext",
        "extension": "txt",
    ...
    },
    {
        ...
        "sections": [
            "title-block", "abstract", "introduction", "background", "method",
            "architecture", "normative-requirements", "results",
            "implementation-guidance", "limitations", "conclusion", "references",
            "provenance",
        ],
        "required": ["title-block", "abstract", "introduction", "method", "references",
                     "provenance"],
        "renderer": "markdown",
        "extension": "md",
        "citation_style": "canonical-id",
    ...
    },
    {
        ...
        "sections": ["title-block", "abstract", "introduction", "method", "architecture",
                     "results", "conclusion", "references", "provenance"],
    ...
    },
    {
        ...
        "genre": "technical-article",
        "label": "Tutorial",
        "sections": ["title-block", "abstract", "background", "method",
                     "implementation-guidance", "validation-strategy", "references",
                     "provenance"],
    ...
    },
    {
        ...
        "label": "Patent Draft",
        "sections": [
            "title-block", "patent-field", "patent-background", "patent-summary",
            "patent-detailed-description", "patent-claims",
            "patent-industrial-applicability", "prior-art", "references", "provenance",
        ],
        "required": ["title-block", "patent-field", "patent-summary",
                     "patent-detailed-description", "patent-claims", "provenance"],
        "renderer": "plaintext",
        "extension": "txt",
        "citation_style": "canonical-id",
    ...
    },
    {
        ...
        "sections": [
            "title-block", "abstract", "problem-statement", "objective",
            "normative-requirements", "specification", "standards-conformance",
            "validation-strategy", "prior-art", "references", "provenance",
        ],
        "required": ["title-block", "abstract", "normative-requirements", "specification",
                     "references", "provenance"],
        "renderer": "markdown",
        "extension": "md",
        "citation_style": "canonical-id",
    ...
    },
    {
        ...
        "sections": ["title-block", "abstract", "normative-requirements", "specification",
                     "validation-strategy", "references", "provenance"],
    ...
    },
    {
        ...
        "sections": [
            "title-block", "executive-summary", "introduction", "method",
            "contributions", "results", "evaluation", "standards-conformance",
            "substrate", "conclusion", "references", "provenance",
        ],
        "required": ["title-block", "introduction", "results", "contributions",
                     "references", "provenance"],
        "renderer": "markdown",
        "extension": "md",
        "citation_style": "canonical-id",
    ...
    },
    {
        ...
        "label": "Preprint",
        "sections": _ACADEMIC_CORE,
        "required": ["title-block", "abstract", "introduction", "results", "references",
                     "provenance"],
        "renderer": "markdown",
        "extension": "md",
        "citation_style": "canonical-id",
    ...
    },
    {
        ...
        "sections": ["title-block", "abstract", "introduction", "related-work",
                     "prior-art", "discussion", "conclusion", "references", "provenance"],
    ...
    },
    {
        ...
        "sections": ["title-block", "abstract", "objective", "method",
                     "evaluation-criteria", "results", "evaluation", "limitations",
                     "conclusion", "references", "provenance"],
        "required": ["title-block", "abstract", "method", "results", "references",
                     "provenance"],
        "renderer": "markdown",
    ...
    },
    {
        ...
        "sections": ["title-block", "introduction", "background", "method",
                     "architecture", "results", "evaluation", "discussion",
                     "limitations", "conclusion", "references", "provenance"],
        "required": ["title-block", "introduction", "method", "results", "references",
                     "provenance"],
        "renderer": "markdown",
        "extension": "md",
        "citation_style": "canonical-id",
    ...
    },
    {
        ...
        "genre": "book",
        "label": "Book Chapter",
        "sections": ["title-block", "abstract", "introduction", "background", "method",
                     "architecture", "discussion", "conclusion", "references",
                     "provenance"],
        "required": ["title-block", "introduction", "background", "references",
                     "provenance"],
        "renderer": "markdown",
        "extension": "md",
        "citation_style": "canonical-id",
...
def _validate_rule(key: str, rule: Mapping[str, Any]) -> None:
    ...
    if source not in _RULE_SOURCES:
        raise KernelError("unknown section rule source", section=key, source=source,
                          allowed=sorted(_RULE_SOURCES))
    if not rule.get("ref") and not rule.get("derive_field"):
        raise KernelError("section rule must name a ref field or a derived field",
                          section=key)
...
class FormatRegistry:
    ...
    def register_format(self, entry: Mapping[str, Any]) -> FormatDescriptor:
        ...
        if not sections:
            raise KernelError("format descriptor requires at least one section",
                              format_id=format_id)
        ...
        if outside:
            raise KernelError("required section is not part of the format",
                              format_id=format_id, outside=outside)
    ...
    def load_file(self, path: str | Path) -> tuple[FormatDescriptor, ...]:
        ...
        if not isinstance(payload, Mapping):
            raise KernelError("format declaration file must contain an object",
                              path=str(path))
    ...
    def get(self, format_id: str) -> FormatDescriptor:
        ...
        if descriptor is None:
            raise FormatUnknownError("publication format is not registered",
                                     format_id=format_id, registered=self.format_ids())
        return descriptor
    ...
    def section(self, key: str) -> SectionType:
        ...
        if section is None:
            raise KernelError("section type is not registered", section=key,
                              registered=sorted(self._sections))
        return section
