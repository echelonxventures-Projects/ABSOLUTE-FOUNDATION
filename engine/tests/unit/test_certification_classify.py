...
def test_first_match_wins_so_the_table_order_is_the_semantics() -> None:
    """A ``raise NotImplementedError`` is defensive (UCI-K-04). Under a typing guard the LINE is
    still the raise, so the ordering claim is checked where it is actually observable: the impossible
    rules are declared before the defensive ones."""
...
def test_the_generated_marker_is_case_insensitive_and_accepts_the_common_spellings() -> None:
    for head in ("DO NOT EDIT", "do not edit", "auto-generated", "autogenerated", "Generated by x", "@generated"):
