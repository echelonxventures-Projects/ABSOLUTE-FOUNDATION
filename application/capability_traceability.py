"""EC3-B12-U02 — Traceability record (No-Orphan closure, GOV-001-T3).

Every realized Capability records a closed lineage (EC-3 AP-4 §5/§9):

* **Backward:** ``AMC-02 → APPLICATION-006 → APPLICATION-005 → APPLICATION-001 →
  ARCH-APPLICATION-001 → 12-APPLICATION@b7e7657``.
* **Substrate:** the frozen foundations ``ENG-001…005`` (EL-1), ``RL-F2``, ``PL-F2``,
  ``SF-2``, ``DF-2`` — referenced, not redefined (UAL-02).
...
from application.capability import FOUNDATION_REUSE, Capability
...
TRACE_FORMAT = "ucos-application-capability-traceability/1.0.0"
