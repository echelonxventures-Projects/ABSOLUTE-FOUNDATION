"""EC3-B13-U01 — Traceability record (No-Orphan closure, GOV-001-T3).

Every realized Infrastructure Capability records a closed lineage (EC-3-B13-P01 §5):

* **Backward:** ``InfrastructureCapability → INFRASTRUCTURE-006 → INFRASTRUCTURE-005 →
...
* **Substrate:** the frozen foundations ``ENG-001…005`` (EL-1), ``RL-F2``, ``PL-F2``,
  ``SF-2`` — referenced, not redefined (UIL-02).
* **Forward:** the realized Infrastructure Capability construct + its
...
from infrastructure.capability import FOUNDATION_REUSE, InfrastructureCapability
...
class TraceabilityRecord:
    """A deterministic, closed No-Orphan lineage record for a realized capability."""
...
def build_traceability(
    capability: InfrastructureCapability, *, unit: str, forward: tuple[str, ...]
) -> TraceabilityRecord:
