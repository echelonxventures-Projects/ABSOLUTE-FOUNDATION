...
from ucos_platform.foundation.bootstrap import bootstrap_platform
...
from ucos_platform.identity.contracts import IDENTITY_CONTRACTS, CapabilityGroup, Decision
from ucos_platform.identity.errors import AuthorizationError
...
from ucos_platform.identity.roles import default_role_registry
from ucos_platform.identity.service import (
    ACCESS_EVENT,
...
from ucos_platform.identity.sessions import SessionRegistry
