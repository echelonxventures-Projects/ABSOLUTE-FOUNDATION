...
from ucos_platform.identity.errors import PermissionResolutionError
from ucos_platform.identity.permissions import PermissionEngine, expand_permissions
...
def test_unknown_role_fails_closed():
    ...
    from ucos_platform.identity.roles import RoleRegistry, default_role_definitions
