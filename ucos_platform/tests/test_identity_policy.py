...
from ucos_platform.identity.contracts import AccessRequest, CapabilityGroup, Decision
...
from ucos_platform.identity.policy import NamedPolicyRule, PolicyEngine
...
def test_custom_rule_can_deny_and_names_exposed():
    def deny_all(principal, request, effective):
        from ucos_platform.identity.contracts import AccessDecision
