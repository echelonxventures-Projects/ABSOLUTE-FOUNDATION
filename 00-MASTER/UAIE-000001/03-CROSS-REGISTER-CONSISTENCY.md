...
**References checked:** 1478 · **unresolved:** 0

| Register | Path | Owner | Refs | Broken | Status |
|---|---|---|---|---|---|
| `UAIE-REG-01` | `00-BOOK/DATA/artifacts.json` | `00-BOOK/tools/ukb.py` | 1233 | 0 | **CONSISTENT** |
| `UAIE-REG-03` | `00-CMG/CMG-REGISTRY.json` | `00-CMG/tools/cmg_validate.py` | 44 | 0 | **CONSISTENT** |
| `UAIE-REG-09` | `intelligence/UCOS-RIE-CAPABILITY-CATALOG.json` | `intelligence/rie/engine.py` | 131 | 0 | **CONSISTENT** |
