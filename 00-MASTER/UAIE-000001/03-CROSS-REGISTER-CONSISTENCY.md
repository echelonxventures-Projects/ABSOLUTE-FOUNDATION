...
**References checked:** 1464 · **unresolved:** 0

| Register | Path | Owner | Refs | Broken | Status |
|---|---|---|---|---|---|
| `UAIE-REG-01` | `00-BOOK/DATA/artifacts.json` | `00-BOOK/tools/ukb.py` | 1232 | 0 | **CONSISTENT** |
| `UAIE-REG-03` | `00-CMG/CMG-REGISTRY.json` | `00-CMG/tools/cmg_validate.py` | 43 | 0 | **CONSISTENT** |
| `UAIE-REG-09` | `intelligence/UCOS-RIE-CAPABILITY-CATALOG.json` | `intelligence/rie/engine.py` | 119 | 0 | **CONSISTENT** |
