...
|---|---|---|---|---|---|---|---|
| `UAIE-REG-01` | every repository artifact | `00-BOOK/DATA/artifacts.json` | json | **RESOLVES** | 1232 | 0 | UAIE-FAC-01, UAIE-FAC-06 |
...
| `UAIE-REG-09` | every capability | `intelligence/UCOS-RIE-CAPABILITY-CATALOG.json` | json | **RESOLVES** | 119 | 0 | UAIE-FAC-05, UAIE-FAC-08 |
