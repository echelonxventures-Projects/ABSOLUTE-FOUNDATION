...
|---|---|---|---|---|---|---|---|
| EP-001 | 2 | CRITICAL / Realization | Governance/Constitutions | 22 | RATIFY:22 | none | Constitutional Governance Auth |
| EP-002 | 2 | CRITICAL / Realization | Operational-Memory | 9 | IMPLEMENT:5; RATIFY:4 | none | Constitutional Governance Auth |
...
| EP-010 | 5 | HIGH / Realization | Runtime | 4 | IMPLEMENT:4 | waves<5 | Certified Implementation Engin |
...
| EP-020 | 8 | MEDIUM / Realization | Operational-Memory | 9 | POPULATE:5; RATIFY:4 | waves<8 | Knowledge Authority |

### Package specifications (scope / inputs / outputs / acceptance)

**EP-001 — Governance/Constitutions · Wave 2 (CRITICAL / Realization)**

- Scope: 22 units (RATIFY×22) in `02-MASTER`
...
- Scope: 9 units (IMPLEMENT×5, RATIFY×4) in `00-MASTER`
- Inputs: certified FREEZE A–E; outputs of all packages in waves < 2
...
- Scope: 4 units (IMPLEMENT×4) in `08-RUNTIME`
- Inputs: certified FREEZE A–E; outputs of all packages in waves < 5
...
- Scope: 9 units (POPULATE×5, RATIFY×4) in `00-MASTER`
- Inputs: certified FREEZE A–E; outputs of all packages in waves < 8
- Outputs: Operational-Memory objects advanced to next lifecycle state
- Dependencies: all wave<8 packages certified
