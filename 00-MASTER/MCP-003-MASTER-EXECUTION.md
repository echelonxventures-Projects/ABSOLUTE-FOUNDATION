...
| MEP-03 | EC-3 Band 12 (Application) realization | EC-3 Executor | Band 11; ARCH-APPLICATION-001 | P3 | **SATISFIED (AP-4)** | **OPEN** (admitted; RUNNABLE root; realization NOT_STARTED) | Applications compose services per ARCH-APPLICATION-001 | Band-12 CCE-COMPLETE + certification | 0 |
