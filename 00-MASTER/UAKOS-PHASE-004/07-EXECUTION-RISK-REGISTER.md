...
| Governance | MEDIUM | 20 units governance-deferred (WAITING_GOVERNANCE) | governance determination required before scheduling |
| Validation | MEDIUM | 112 implement units need new tests | per-unit validation plan (Register 05) |
| Certification | HIGH | 46 units carry an unmet certification gap | certification gates G5/G6/G8 (Register 06) |
...
**Highest-risk concentration:** 34 CRITICAL-tier implementation units (Wave 2) — the constitutional foundation that gates all HIGH/MEDIUM work.
