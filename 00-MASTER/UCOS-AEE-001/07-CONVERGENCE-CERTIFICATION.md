...
| `CONV-02` | every blocking observation is satisfied | `0` | `2` | yes | **VIOLATED** |
| `CONV-03` | every required actuator in the selected tier exits successfully | `0` | `1` | yes | **VIOLATED** |
