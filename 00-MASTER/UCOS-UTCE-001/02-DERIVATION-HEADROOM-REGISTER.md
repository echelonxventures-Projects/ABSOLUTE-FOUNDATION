...
|---|---|---|---|---|---|---|---|
| `UTCE-DR-01` | `Parent` | from | `architecture` | 1193 | 1193 | 0 | `UEDGE-000000002`, `UEDGE-000000005`, `UEDGE-000000907` |
...
| `UTCE-DR-05` | `Implemented-By` | from | `implementation` | 17 | 17 | 0 | `UEDGE-000002918`, `UEDGE-000002920`, `UEDGE-000002986` |
