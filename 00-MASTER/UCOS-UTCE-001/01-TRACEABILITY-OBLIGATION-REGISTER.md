...
|---|---|---|---|---|
| `requirement` | 81 | 1151 | `AUTHORITY`, `AUTHORITIES`, `AUTHORIZED-BY`, `GOVERNED-BY`, `TRACES-TO`, `TRACES TO` | DISCHARGEABLE |
| `architecture` | 1231 | 1 | `PARENT`, `DEPENDS-ON`, `DEPENDS ON`, `IMPLEMENTS`, `REALIZES`, `CONSUMES`, `USES`, `READS` | DISCHARGEABLE |
| `design` | 0 | 1232 | — none | MECHANISM-ABSENT |
| `implementation` | 17 | 1215 | `IMPLEMENTS`, `REALIZES` | DISCHARGEABLE |
| `source_code` | 0 | 1232 | — none | MECHANISM-ABSENT |
| `unit_test` | 0 | 1232 | `TESTS` | DISCHARGEABLE |
| `integration_test` | 0 | 1232 | — none | MECHANISM-ABSENT |
| `functional_test` | 0 | 1232 | — none | MECHANISM-ABSENT |
| `security_test` | 0 | 1232 | `SECURES` | DISCHARGEABLE |
| `certification` | 0 | 1232 | `CERTIFIES` | DISCHARGEABLE |
| `deployment` | 0 | 1232 | `DEPLOYS` | DISCHARGEABLE |
| `production` | 0 | 1232 | `PRODUCES`, `EMITS`, `WRITES`, `PUBLISHES` | DISCHARGEABLE |
| `operations` | 0 | 1232 | — none | MECHANISM-ABSENT |
