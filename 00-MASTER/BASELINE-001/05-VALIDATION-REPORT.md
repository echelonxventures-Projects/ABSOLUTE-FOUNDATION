...
| `BLN-VAL-16` CEILING-DISCLOSED | the located ceiling clause is present, the recorded vacancy is located, and the register discloses the ceiling token | YES | YES | **NO** | 1 |
...
| `BLN-VAL-26` CAPABILITY-DISCHARGED | every declared capability is discharged by a measure that ran | YES | YES | **NO** | 1 |

## Measured failures

### `BLN-VAL-16` CEILING-DISCLOSED

- BLN-CEI-01: no vacancy is located, so the ceiling is unbacked

### `BLN-VAL-26` CAPABILITY-DISCHARGED

- BLN-CAP-11: ceiling_disclosed
